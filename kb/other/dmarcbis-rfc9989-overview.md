...
| 国内主流邮箱服务商 | 支持基本 DMARC 验证 | 有限支持 | - |
| 国内主流企业邮箱 | 支持（企业版） | 支持 | - |
| 国内主流企业邮箱 | 支持 | 支持 | - |
| 国产邮件系统 | 完整支持（兼容 RFC 7489 和部分 RFC 9989） | 支持 | 支持 rua 解析 |
...
### 7.2 国产邮件系统 等国产邮件系统如何适配

国产邮件系统 作为国内部署最广泛的邮件系统之一，已在近年版本中加强了对 DMARC 的完整支持。针对 RFC 9989 的适配，预计需要关注以下方面：
...
* **关注**：跟踪国内邮件系统供应商（国产邮件系统、国内主流企业邮箱等）的 RFC 9989 适配计划。
