---
title: "DKIM2 监管链签名机制深度解读：链式托管、重放防护与 DSN 安全"
source: "https://ztpop.net/kb/dkim2-chain-of-custody.html"
license: CC-BY 4.0
---
...
* [DKIM2：它对邮件的未来意味着什么？（Laura Atkins 解读中文翻译）](/kb/dkim2-main.html)
* [DKIM2、异步退信与 VERP：ESP 需要做好的准备](/kb/dkim2-async-bounce-verp.html)
* [DMARCbis RFC 9989 概览：DMARC 2.0 的核心变更](/kb/dmarcbis-rfc9989-overview.html)
* [DKIM 邮件签名机制深度解析 — RFC 6376](/kb/dkim-guide.html)
* [RFC 8463 DKIM 的 ed25519 签名](/kb/rfc8463-dkim-ed25519.html)

---

*本文章由 [ztpop.net 知识库](https://ztpop.net/kb/dkim2-chain-of-custody.html) 镜像发布。采用 [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) 许可，可自由引用，仅需标注来源。*
