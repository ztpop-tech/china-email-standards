...
| --- | --- | --- | --- | --- | --- |
| Coremail 邮件系统 | 盈世科技 | 鲲鹏/飞腾/海光 + 麒麟/统信/中标麒麟/方德 | SM2/SM3/SM4 | 大型企业/高校/政府 | ¥30-200 万（不含实施） |
| U-Mail 邮件安全网关 | U-Mail | 鲲鹏 + 麒麟/统信 | SM2/SM3 | 邮件安全网关垂直 | ¥8-80 万（单项目） |
| 网际思安邮件安全网关 | 网际思安科技 | 鲲鹏/飞腾/海光/兆芯 + 麒麟/统信/方德 + 达梦/金仓/GBase DB | SM2/SM3/SM4 | 邮件安全网关+DLP | ¥8-80 万；维保 ¥8 万/年 |
| CACTER 邮件安全网关 | 派网易安 | 主流信创平台覆盖 | SM2/SM3 | 云网关（SaaS 15 分钟开通）+硬件 | 询价制 |
...
```
是否有信创合规硬性要求？
├─ 是 → 评估国产商业方案（Coremail / U-Mail / 定制）
│         └─ 是否需要邮件系统 + 安全网关 + 归档一体化？
│              ├─ 是 → Coremail（一体化）/ 网际思安（安全垂直）
│              └─ 否 → U-Mail（网关单一场景）
└─ 否 →
