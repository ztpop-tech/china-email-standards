...
source: "https://ztpop.net/kb/kb-art1-exchange-cloud-migration.html"
license: CC-BY 4.0
---
...
4. 锁定源邮箱：将源邮箱设为只读状态，完成最终同步后标记就绪
...
*本文章由 [ztpop.net 知识库](https://ztpop.net/kb/kb-art1-exchange-cloud-migration.html) 镜像发布。采用 [CC-BY 4.0](https://creativecommons.org/licenses/by/4.0/) 许可，可自由引用，仅需标注来源。*
