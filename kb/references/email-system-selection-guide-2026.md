...
采购评估不应只比较商业产品。以 Stalwart、KumoMTA、Postfix + Dovecot、Apache James 为代表的开源邮件系统，在 2026 年已具备完整的 SMTP/IMAP/JMAP、DKIM/DMARC/ARC 支持与生产级性能（Stalwart 内置 DKIM2 与 DMARCbis 支持，见 RFC 9989/9990/9991）。开源方案的核心优势是零许可成本与完全可控的代码审计能力；代价是需要自建运维能力，且国内信创合规场景（等保 2.0、GB/T 37002-2026）需自行完成合规评估与适配。

对于信创采购项目，若预算与运维团队允许，可采用「开源内核 + 商业服务」的混合路线：以开源系统承载核心邮件服务，由具备信创资质的集成商完成国密改造（SM2/SM3/SM4，GB/T 39786-2021）与等保测评支撑。完整的多维度对比（功能、性能、安全、合规、TCO）参见站内专题：[2026 开源邮件服务器对比](/kb/open-source-mail-server-comparison-2026.html)与[开源邮件基础设施盘点](/kb/open-source-mail-infrastructure-2026.html)。
